...
export default function HeroSection() {
  return (
    <section className="py-20 sm:py-24 w-full max-w-screen-lg mx-auto flex justify-center px-4">
      <div className="flex justify-center md:justify-start  w-full items-center border rounded-t-2xl h-32 sm:h-52 relative">
        ...
        <p className="md:ml-8 lg:mr-52 z-10 text-3xl text-center md:text-start sm:text-5xl md:text-6xl leading-[40px] md:leading-[62px] font-extralight italic tracking-tighter">
